...
export default function LiveCamera({ onCapture, onClose }: Props) {
  ...
  if (!permission.granted) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.msg}>Autorisation caméra requise pour scanner l'étiquette.</Text>
  ...
  const snap = async () => {
    ...
    try {
      ...
      Alert.alert("Erreur", e?.message || "Capture échouée");
    } finally {
      setCapturing(false);
    }
  };
...
const styles = StyleSheet.create({
  ...
  topBar: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingTop: 50, paddingHorizontal: spacing.md, paddingBottom: spacing.md, backgroundColor: "rgba(0,0,0,0.35)" },
  ...
  bottomBar: { alignItems: "center", paddingBottom: 50, paddingTop: spacing.lg, backgroundColor: "rgba(0,0,0,0.35)" },
  hint: { color: "#fff", marginBottom: spacing.md, fontSize: 13, opacity: 0.9 },
  shutter: { width: 74, height: 74, borderRadius: 37, backgroundColor: "rgba(255,255,255,0.3)", alignItems: "center", justifyContent: "center", borderWidth: 3, borderColor: "#fff" },
  shutterInner: { width: 58, height: 58, borderRadius: 29, backgroundColor: "#fff" },
  center: { flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: colors.bg, padding: spacing.xl },
  msg: { color: colors.textPrimary, textAlign: "center", marginTop: spacing.md, marginBottom: spacing.lg, fontSize: 14 },
